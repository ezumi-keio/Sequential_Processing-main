...
class SwinUnit(nn.Module):
    r""" SwinIR
        A PyTorch impl of core part of : `SwinIR: Image Restoration Using Swin Transformer`, based on Swin Transformer.
...
if __name__ == '__main__':
    ...
    model = SwinUnit(upscale=2, img_size=(height, width),
